...
Public Class TPenyewaan
    ...
    Private Sub TPenyewaan_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Do While dr.Read
                ...
                CBkendaraan.Items.Add(dr("Tanspot"))
    ...
    Private Sub BTsimpan_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTsimpan.Click
        ...
        Try
            ...
            If TB1.Text = "Other" Then
                query = "INSERT INTO Kendaraan (RequestId,NameRequestor,RequestorID,Unit,DateIssue,UnitDestination,acRegis,Transportation,Phone,Instruction) VALUES (" & uid & ",'" & TBnama.Text & "','" & TBid.Text & "','" & TBunit.Text & "','" & Format(DateTimePicker1.Value, "yyyy-MM-dd") & "','" & TBintruc.Text & "','" & TBtujuan.Text & "','" & TBkelas.Text & "','" & CBkendaraan.Text & "','" & TBtlpn.Text & "')"
            End If
    ...
    Private Sub CBkendaraan_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CBkendaraan.SelectedIndexChanged

        If CBkendaraan.Text = "Other " Then
